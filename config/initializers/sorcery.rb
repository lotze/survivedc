...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :external, :user_activation]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = SurvivedcMailer
    ...
    user.reset_password_mailer = SurvivedcMailer
